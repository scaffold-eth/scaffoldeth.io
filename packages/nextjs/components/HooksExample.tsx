...
const Red = ({ children }: { children: ReactNode }) => {
  return <span className="text-[#FF5962]">{children}</span>;
};
const Cyan = ({ children }: { children: ReactNode }) => {
  return <span className="text-[#00B0A6]">{children}</span>;
};

const Purple = ({ children }: { children: ReactNode }) => {
  return <span className="text-[#7B61FF]">{children}</span>;
};
      ...
      <div className="bg-base-300/40 w-full h-full border border-primary rounded-3xl p-4 lg:p-6 text-xs lg:text-sm  font-mono overflow-x-scroll whitespace-nowrap  lg:overflow-auto lg:whitespace-normal">
        ...
        <p className="my-3">
          ...
          <span className="inline-block ml-4">
            <Cyan>contractName</Cyan>: <Cyan> &quot;YourContract&quot;</Cyan>,
            <br />
            <Cyan>functionName</Cyan>: <Cyan> &quot;setPurpose&quot;</Cyan>,
            <br />
            <Cyan>args</Cyan>: [<Cyan>&quot;The value to set&quot;</Cyan>],
            <br />
            <Cyan>blockConfirmation</Cyan>: <Cyan>1</Cyan>,
            <br />
